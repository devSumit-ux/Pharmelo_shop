...
const slidePrompts: Record<string, string> = {
  ...
  'demo': "How it works. Chalo dekhte hain yeh kaam kaise karta hai. Step one, aap apne prescription ki photo WhatsApp par bhejte hain. Step two, hamara AI usko read karke medicines aur doctor ki details nikalta hai. Step three, aapka order Consumer App mein sync ho jata hai. Step four, local pharmacy partner ko unke app par order milta hai. Step five, woh order accept karke pack karna shuru karte hain. Aur finally, aapko WhatsApp par confirmation mil jata hai. Hai na simple?",
  ...
  'help': "How you can help. Is healthcare revolution mein hamara saath dein. Hamare survey mein participate karein aur apna honest feedback dein. Apne local doctors aur pharmacists ko Pharmelo ke baare mein batayein. Aur March launch ke liye hamari priority waitlist join karein."
};
